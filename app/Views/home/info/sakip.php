        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title">Informasi SAKIP</h1>
                <?= $breadcrumbs; ?>
              </div>
          </div><!-- Col end -->
        </div><!-- Row end -->
    ...
    <div class="row">
        <div class="col-lg-12 col-md-6 mb-5">
          <div class="ts-service-box">
             ...
             <table class="table table-bordered table-striped" id="data-sakip" width="100%" cellspacing="0">
                 <thead>
                     <tr>
                         <th>No</th>
                         <th>Opd</th>
                 ...
                 <tbody>
                     ...
                     <tr>
                        ...
                        <td><a href="<?php echo base_url('info/d_sakip/' . $row->sakip_id) ?>">Download</a></td>
                     </tr>
                     <?php
                     $no++;
                     }
