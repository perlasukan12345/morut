    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                ...
                <form action="<?php echo base_url('flash/update/'. $bupati->flash_id) ?>" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="token" value="<?= generate_token('token_flash'); ?>">
                    <input type="hidden" name="imageOld" value="<?= $bupati->img ?>">
                    <div class="card-body">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-6">
                                    <label for="name">Name</label>
                                    <input type="text" class="form-control <?= ($validation->hasError('name')) ? 'is-invalid' : ''; ?>" id="name" name="name" value="<?= $bupati->name ?>">
                                 ...
                                 <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control <?= ($validation->hasError('address')) ? 'is-invalid' : ''; ?>" id="address" name="address" value="<?= $bupati->address ?>">
                                    <div class="invalid-feedback">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <img src="<?= base_url('/img/setting/'. $bupati->img); ?>" alt="img-preview" class="img-thumbnail" heigth="300" width="200">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <textarea class="form-control <?= ($validation->hasError('job_history')) ? 'is-invalid' : ''; ?>" id="job_history" name="job_history" rows="8"><?= $bupati->job_history ?></textarea>
                                    <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <textarea class="form-control <?= ($validation->hasError('education_background')) ? 'is-invalid' : ''; ?>" id="education_background" name="education_background" rows="8"><?= $bupati->education_background ?></textarea>
                                    <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <textarea class="form-control <?= ($validation->hasError('organization_history')) ? 'is-invalid' : ''; ?>" id="organization_history" name="organization_history" rows="8"><?= $bupati->organization_history ?></textarea>
                                    <div class="invalid-feedback">
