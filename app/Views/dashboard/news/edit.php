    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            <div class="card shadow mb-4">
                ...
                <form action="<?php echo base_url('news/update/' . $news->news_id) ?>" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="token" value="<?= generate_token('news_edit'); ?>">
                    <input type="hidden" name="imageOld" value="<?= $news->image_name; ?>">
                    <div class="card-body">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-12">
                                    <label for="Title">Title</label>
                                    <input type="text" class="form-control <?= ($validation->hasError('title')) ? 'is-invalid' : ''; ?>" id="title" name="title" value="<?= old('title', $news->title); ?>">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-control <?= ($validation->hasError('user')) ? 'is-invalid' : ''; ?>" name="user" id="user">
                                        ...
                                        <?php foreach ($user as $row) : ?>
                                            <option value="<?php echo $row->user_id; ?>" <?= ($row->user_id === $news->user_id) ? 'selected' : ''; ?>><?php echo $row->name; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-control <?= ($validation->hasError('category')) ? 'is-invalid' : ''; ?>" name="category" id="category">
                                        ...
                                        <?php foreach ($category as $row) : ?>
                                            <option value="<?php echo $row->category_news_id; ?>" <?= ($row->category_news_id === $news->category_news_id) ? 'selected' : ''; ?>><?php echo $row->category_name; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <img src="<?= base_url('/img/news/' . $news->image_name); ?>" alt="img-preview" class="img-thumbnail">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <textarea class="form-control <?= ($validation->hasError('content')) ? 'is-invalid' : ''; ?>" id="content" name="content" rows="8"><?= $news->content; ?></textarea>
                                    <div class="invalid-feedback">
