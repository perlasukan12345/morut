   ...
   <div class="row">
      <div class="col-sm-6">
         <div class="card shadow mb-4">
            ...
            <form action="<?php echo base_url('category_gallery/update/' . $post->category_gallery_id) ?>" method="post">
               <input type="hidden" name="token" value="<?= generate_token('category_gallery_edit'); ?>">
               <div class="card-body">
               ...
               <div class="card-footer">
                  <button type="submit" name="edit_category_image" class="btn btn-success">Update</button>
               </div>
            </form>
         </div>
      </div>
