    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            <div class="card shadow mb-4">
                ...
                <form action="<?php echo base_url('content_menu/create/'.$menu) ?>" method="post">
                    <input type="hidden" name="token" value="<?= generate_token('content_menu_add'); ?>">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select class="form-control <?= ($validation->hasError('category')) ? 'is-invalid' : ''; ?>" name="category" id="category">
                                ...
                                <?php foreach ($category as $row) : ?>
                                    <option value="<?php echo $row->category_menu_id; ?>"><?php echo $row->category; ?></option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="card-footer">
                        <button type="submit" name="add_content_profile" class="btn btn-success">Save</button>
                    </div>
                </form>
            </div>
        </div>
