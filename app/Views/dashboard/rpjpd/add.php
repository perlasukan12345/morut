        ...
        <div class="col-sm-10">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Add RPJPD</h6>
                </div>
                <form action="<?php echo base_url('rpjpd/create') ?>" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="token" value="<?= generate_token('rpjpd_add'); ?>">
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        <button type="submit" name="add_rpjpd" class="btn btn-success">Save</button>
                    </div>
                </form>
            </div>
        </div>
