...
--
-- Host: localhost:3306
-- Waktu pembuatan: 19 Okt 2022 pada 19.07
-- Versi server: 5.7.33
-- Versi PHP: 7.4.19
...
--
-- Dumping data untuk tabel `category_menu`
--

INSERT INTO `category_menu` (`category_menu_id`, `menu`, `category`) VALUES
(1, 'profile', 'Tentang Kabupaten'),
(2, 'profile', 'Pemerintah Kabupaten'),
(3, 'information', 'Perijinan'),
(4, 'information', 'Pariwisata');
...
--
-- Struktur dari tabel `category_opd`
--
...
--
-- Dumping data untuk tabel `category_opd`
--

INSERT INTO `category_opd` (`category_opd_id`, `category`) VALUES
(1, 'Badan'),
(2, 'Dinas'),
(3, 'Kecamatan');
...
--
-- Dumping data untuk tabel `content_menu`
--

INSERT INTO `content_menu` (`menu_id`, `category_menu_id`, `menu`, `title`, `content`) VALUES
...
INSERT INTO `gis_category_facilities` (`category_facilities_id`, `category_name`, `category_icon`) VALUES
(1, 'kesehatan', 'kes.png'),
(2, 'pelayanan publik', '1666184182_a3233b1346d61bb51588.png');
...
INSERT INTO `opd` (`opd_id`, `category_opd_id`, `opd`, `url`) VALUES
(1, 2, 'Dinas Pendidikan dan Kebudayaan Daerah', 'https://morowaliutarakab.go.id/'),
(2, 2, 'Dinas Kesehatan Daerah', 'https://morowaliutarakab.go.id/'),
(3, 2, 'Dinas Pekerjaan Umum Penataan Ruang Perumahan dan Kawasan Pemukiman Daerah', 'https://morowaliutarakab.go.id/'),
(4, 2, 'Dinas Perhubungan Daerah', 'https://morowaliutarakab.go.id/'),
(5, 1, 'Satuan Polisi Pamong Praja dan Pemadam Kebakaran Daerah', 'https://morowaliutarakab.go.id/'),
(6, 2, 'Dinas Sosial Daerah', 'https://morowaliutarakab.go.id/'),
(7, 2, 'Dinas Tenaga Kerja dan Transmigrasi Daerah', 'https://morowaliutarakab.go.id/'),
(8, 2, 'Dinas Pertanian dan Pangan Daerah', 'https://morowaliutarakab.go.id/'),
(9, 2, 'Dinas Lingkungan Hidup Daerah', 'https://morowaliutarakab.go.id/'),
(10, 2, 'Dinas Kependudukan dan Pencatatan Sipil Daerah', 'https://morowaliutarakab.go.id/'),
(11, 2, 'Dinas Pemberdayaan Masyarakat dan Desa Daerah', 'https://morowaliutarakab.go.id/'),
(12, 2, 'Dinas Pengendalian Penduduk Keluarga Berencana Pemberdayaan Perempuan dan Perlindungan Anak Daerah', 'https://morowaliutarakab.go.id/'),
(13, 2, 'Dinas Komunikasi dan Informatika Daerah', 'https://morowaliutarakab.go.id/'),
(14, 2, 'Dinas Penanaman Modal dan Pelayanan Terpadu Satu Pintu Daerah', 'https://morowaliutarakab.go.id/'),
(15, 2, 'Dinas Koperasi Usaha Mikro, Kecil dan Menengan, Perindustrian dan Perdagangan Daerah', 'https://morowaliutarakab.go.id/'),
(16, 2, 'Dinas Perpustakaan Daerah', 'https://morowaliutarakab.go.id/'),
(17, 2, 'Dinas Perikanan Daerah', 'https://morowaliutarakab.go.id/'),
(18, 2, 'Dinas Pariwisata Pemuda dan Olahraga Daerah', 'https://morowaliutarakab.go.id/'),
(19, 1, 'Badan Perencanaan Pembangunan Penelitian dan Pengembangan Daerah', 'https://morowaliutarakab.go.id/'),
(20, 1, 'Badan Pengelolaan Keuangan dan Aset Daerah', 'https://morowaliutarakab.go.id/'),
(21, 1, 'Badan Penanggulangan Bencana Daerah', 'https://morowaliutarakab.go.id/'),
(22, 1, 'Badan Kepegawaian dan Pengembangan Sumber Daya Manusia Daerah', 'https://morowaliutarakab.go.id/'),
(23, 1, 'Badan Kesatuan Bangsa Daerah', 'https://morowaliutarakab.go.id/'),
(24, 1, 'Badan Pendapatan Daerah', 'https://morowaliutarakab.go.id/'),
(25, 1, 'Bagian Administrasi Pemerintahan Umum', 'https://morowaliutarakab.go.id/'),
(26, 1, 'Bagian Hukum', 'https://morowaliutarakab.go.id/'),
(27, 1, 'Bagian Organisasi', 'https://morowaliutarakab.go.id/'),
(28, 1, 'Bagian Umum', 'https://morowaliutarakab.go.id/'),
(29, 1, 'Bagian Administrasi Perekonomian', 'https://morowaliutarakab.go.id/'),
(30, 1, 'Bagian Protokol dan Komunikasi Pimpinan', 'https://morowaliutarakab.go.id/'),
(31, 1, 'Bagian Layanan Pengadaan Barang dan Jasa', 'https://morowaliutarakab.go.id/'),
(32, 1, 'Bagian Administrasi Kesejahteraan Rakyat', 'https://morowaliutarakab.go.id/'),
(33, 1, 'Bagian Administrasi Pembangunan', 'https://morowaliutarakab.go.id/'),
(34, 1, 'Sekretariat Dewan Perwakilan Rakyat Daerah', 'https://morowaliutarakab.go.id/'),
(35, 1, 'Inspektorat Daerah', 'https://morowaliutarakab.go.id/'),
(36, 1, 'Rumah Sakit Umum Daerah', 'https://morowaliutarakab.go.id/'),
(37, 3, 'Kecamatan Petasia', 'https://morowaliutarakab.go.id/'),
(38, 3, 'Kecamatan Petasia Timur', 'https://morowaliutarakab.go.id/'),
(39, 3, 'Kecamatan Petasia Barat', 'https://morowaliutarakab.go.id/'),
(40, 3, 'Kecamatan Lembo', 'https://morowaliutarakab.go.id/'),
(41, 3, 'Kecamatan Lembo Raya', 'https://morowaliutarakab.go.id/'),
(42, 3, 'Kecamatan Mori Atas', 'https://morowaliutarakab.go.id/'),
(43, 3, 'Kecamatan Mori Utara', 'https://morowaliutarakab.go.id/'),
(44, 3, 'Kecamatan Mamosalato', 'https://morowaliutarakab.go.id/'),
(45, 3, 'Kecamatan Soyojaya', 'https://morowaliutarakab.go.id/'),
(46, 3, 'Kecamatan Bungku Utara', 'https://morowaliutarakab.go.id/');
...
(82, 'View About', 'About'),
(83, 'Edit About', 'About'),
(84, 'View Category Profile', 'Category Menu'),
(85, 'Edit Category Profile', 'Category Menu'),
(86, 'Create Category Profile', 'Category Menu'),
(87, 'Delete Category Profile', 'Category Menu'),
(88, 'View Category Information', 'Category Menu'),
(89, 'Create Category Information', 'Category Menu'),
(90, 'Delete Category Information', 'Category Menu'),
(91, 'Edit Category Information', 'Category Menu'),
...
--
-- Struktur dari tabel `priority_program`
--
...
--
-- Dumping data untuk tabel `priority_program`
--
...
ALTER TABLE `category_menu`
  ADD PRIMARY KEY (`category_menu_id`);
...
--
-- Indeks untuk tabel `category_opd`
--
ALTER TABLE `category_opd`
  ADD UNIQUE KEY `category` (`category`),
  ADD KEY `category_opd_id` (`category_opd_id`);

--
-- Indeks untuk tabel `content_menu`
--
...
--
-- Indeks untuk tabel `priority_program`
--
...
--
-- AUTO_INCREMENT untuk tabel `category_menu`
--
ALTER TABLE `category_menu`
  MODIFY `category_menu_id` int(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT untuk tabel `category_opd`
--
ALTER TABLE `category_opd`
  MODIFY `category_opd_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT untuk tabel `content_menu`
--
ALTER TABLE `content_menu`
...
--
-- AUTO_INCREMENT untuk tabel `priority_program`
--
ALTER TABLE `priority_program`
